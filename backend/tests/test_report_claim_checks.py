...
_CHECKS_DE = {
    "qc_metric": {
        "status": "unavailable",
        "reason": "no QC metric measures a differential result",
        "requirement": "qc_binding",
    },
...
_CHECKS_PEAKS = {
    ...
    "raw_reanalysis": {
        "status": "unavailable",
        "reason": "the same run as the QC metric comparison",
        "requirement": "qc_binding",
    },
}
...
PLAN = {
    "reported_experiments": [
        {
            ...
            "reference": {
                "assembly": {"stated": "mm9", "status": "unavailable", "reason": "bioAF cannot supply mm9"},
                "annotation": {
                    "stated": None,
                    "status": "unstated",
                    "reason": "the paper does not state its annotation",
                },
            },
        },
        {
            ...
            "reference": {
                ...
                "annotation": {
                    "stated": "GENCODE M23",
                    "status": "unavailable",
                    "reason": "bioAF supplies Ensembl 102",
                },
            },
        },
    ],
    ...
    "analysis_selection": {
        "current": {
            ...
            "workflow": "nf-core/rnaseq",
            "decided_by": "model",
            "reason": "the authors' table can be compared",
            "confidence": 0.8,
        },
        "history": [{"revision": 1, "claim_index": 2, "superseded": True}],
        "unassessed": [
            {"claim_index": 0, "reason": "not selected for this run; QC metric comparison: a value for one sample"},
...
TARGETS = [
    {
        "claim_text": "we called 8000 peaks",
        "claimed_value": 8000,
        "unit": "peaks",
        "reported_experiment_id": "e1",
        "checks": _CHECKS_PEAKS,
        "bound_by": "model",
    },
    {
    ...
    {
        "claim_text": "524 genes were down",
        "claimed_value": 524,
        "contrast_index": 0,
        "cutoffs": _P,
        "reported_experiment_id": "e2",
...
EVIDENCE = {
    "selection_history": [
        {
            "revision": 1,
            "artifacts": {"level3": {"x": 1}},
            "invalidated_by": ["claim"],
    ...
    "level3_result": {
        ...
        "claim_count": {
            "count": 250,
            "status": "fails",
            "words": "250 against the claim's exactly 257",
...
def test_every_claim_shows_its_four_checks_with_labels():
    ...
    assert [c["key"] for c in claim["checks"]] == [
        "qc_metric",
        "author_results",
        "processed_reanalysis",
        "raw_reanalysis",
...
def test_the_selected_claim_and_the_unassessed_ones_say_so():
    claims = _summary()["claims"]
    assert claims[1]["selection"] == {
        "status": "selected",
        "label": "Selected for this run",
        "check_label": "Reanalysis of processed data",
        "reason": "the authors' table can be compared",
    }
...
def test_each_experiment_shows_its_reference_parts():
    ...
    assert chip["reference"][0] == {
        "part": "assembly",
        "stated": "mm9",
        "resolved": None,
        "status": "unavailable",
        "status_label": "Unavailable",
        "reason": "bioAF cannot supply mm9",
