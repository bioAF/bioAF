...
const makeFile = (overrides: Record<string, unknown> = {}) => ({
  ...
  storage_uri: "gs://bucket/sample_R1.fastq.gz",
  size_bytes: 1048576,
  md5_checksum: "abc123",
  file_type: "fastq",
  tags: [],
...
const filesResponse = {
  files: [
    ...
    makeFile({
      ...
      storage_uri: "gs://bucket/counts.h5ad",
      size_bytes: 5242880,
      md5_checksum: "def456",
      file_type: "h5ad",
      experiment_id: 10,
  ...
  const stuckFiles = {
    files: [
      makeFile({
        ...
        storage_uri: "gs://ingest-bucket/uploads/abc/stuck.fastq.gz",
        experiment_id: 10,
      }),
      makeFile({
        id: 2,
        ...
        storage_uri: "gs://raw-bucket/experiments/10/ok.fastq.gz",
        experiment_id: 10,
      }),
    ],
    total: 2,
