...
export default function ProjectDetailPage() {
  ...
  const filteredAvailable = availableSamples.filter(
    (s) =>
      ...
      (sampleSearch === "" ||
        s.external_id.toLowerCase().includes(sampleSearch.toLowerCase()) ||
      ...
      <main className="flex-1 overflow-y-auto p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            {project.code && (
              <span className="text-sm font-mono bg-gray-100 text-gray-600 px-2 py-0.5 rounded" title="Internal ID">{project.code}</span>
            )}
            {project.external_id && (
              <span className="text-sm font-mono bg-blue-50 text-blue-700 px-2 py-0.5 rounded" title="External ID">{project.external_id}</span>
            )}
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Organism</th>
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tissue</th>
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">QC</th>
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Added By</th>
                          <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Added</th>
                          {canModify && (
        ...
        {viewingSample && (
          <DetailModal
            title={viewingSample.external_id || `Sample #${viewingSample.sample_id}`}
            onClose={() => setViewingSample(null)}
            fields={[
              { label: "Internal ID", value: `#${viewingSample.sample_id}` },
